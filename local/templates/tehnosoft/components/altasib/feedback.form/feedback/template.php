        ...
        $(document).ready(function () {
            var param = {
                ...
                'data': {
                    "AJAX_CALL": "Y",
                    "OPEN_POPUP": "<?=$ALX?>",
                    "ELEMENT_ID_ATTR": "<?=trim($arParams["ALX_IBLOCK_ELEMENT_LINK"])?>",
                    "TARGET_ELEMENT_ID": ""
                },
                ...
                'objClick': '<?=$arResult["ALX_NAME_LINK"]?>',
                'popupAnimation': [
...
<div class="afbf alx_feed_back <? $arParams['INPUT_APPEARENCE'] != 'DEFAULT' ? strtolower($arParams['INPUT_APPEARENCE']) : '' ?>"
     id="alx_feed_back_<?= $ALX ?>">
    <? else: ?>
    <div class="afbf alx_feed_back <? foreach ($arParams['INPUT_APPEARENCE'] as $param) if ($param != 'DEFAULT') echo strtolower($param) . ' ' ?>"
         id="alx_feed_back_<?= $ALX ?>">
        <? endif ?>
        <?
        ?>
        <span class="title-form">Мы с Вами свяжемся и ответим на любые вопросы</span>
